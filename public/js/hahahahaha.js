...
var _declareFunction = require('../utils/declare-function.js');
...
w.onload = function () {
	...
	(0, _declareFunction.fontLoading)().then(function () {
		d.getElementById('now-loading').style.display = 'none';
		location.pathname === '/' && w.initMap();
	});
	(0, _declareFunction.morePicClick)();
	(0, _declareFunction.scrollEvent)();
};
...
w.initMap = function () {
	var nuHouse = { lat: 37.514044, lng: 127.037267 };
...
},{"../utils/declare-function.js":3,"jquery":1}],3:[function(require,module,exports){
'use strict';
...
var w = window;
var d = document;
var fontLoading = function fontLoading() {
	var promise = new Promise(function (resolve, reject) {
		var nowLoadingEl = d.getElementById('now-loading');
		WebFont.load({
			custom: {
...
var morePicClick = function morePicClick() {
	d.getElementById('more-pic').addEventListener('click', function () {
		location.href = location.pathname === '/' ? '/bk-pictures' : '/';
	});
};

exports.fontLoading = fontLoading;
exports.scrollEvent = scrollEvent;
exports.morePicClick = morePicClick;
